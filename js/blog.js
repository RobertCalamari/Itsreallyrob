...
const posts = [
	...
	},
	{
	  ...
	  writer:'Robert Calamari',
	  pinned: '',
	  summary:"As I await for my next website that I will be making, still not sure which one I will be doing yet, I decided I am going to work on small little projects. The first thing I want to work on is messing around with the canvas within HTML. I have always wanted to learn more about it, but never really started, so that is why this will be my first small project. I am thinking of making a similar game to 'Jackbox Games' where you can draw on the screen and play with people...",
	  images:'',
	  tags:'coding100, javascript, html, css',
	  content: tab + "As I await for my next website that I will be making, still not sure which one I will be doing yet, I decided I am going to work on small little projects. The first thing I want to work on is messing around with the canvas within HTML. I have always wanted to learn more about it, but never really started, so that is why this will be my first small project. I am thinking of making a similar game to 'Jackbox Games' where you can draw on the screen and play with people on multiple devices. By doing this I will have to transition over and use Node.JS and Socket.IO, which is not too much of a problem since I have coded with that before. The tough part is trying to figure out how to make this a live site, since I only have ever used it locally. I feel like this should be a relatively easy task, but it will require a good amount a research and long nights on stackoverflow. As of now I am going to be done with my site, unless there is any suggestions that people bring up. I know some parts look wonky, but everything I need is up there and I just have to start getting user feedback to see how I should change some of those parts. I will keep updating on this blog about this small projects as well. As for today, I read a lot about canvases and found a good shell program that does exactly what I want. The reason I am using another code snippet is because I am still not too sure how some of the parts of the code work. As of right now the link to the drawing app is <a href='https://www.robertcalamari.com/pages/games/paintapp.html'>here</a> if anyone would like to view and try it." 

	},
	{
	  date:'09/21/2018',
	  title:'Day 19 - Finished My First Small Project',
	  writer:'Robert Calamari',
	  pinned: '',
	  summary:"Woah! He's back! All three of you reading this just said! Yes, I know it's been almost a week since I have uploaded a blog post. I have just been really busy with stuff, and also coding my first small project. I started off coding the drawing games, but then switched over to another idea. If anyone has played the game piccolo, I wanted to see if I could recreate that. Piccolo is a drinking game where all you do is listen to the prompts that the game tells you to do. It's relatively...",
	  images:'',
	  tags:'coding100, javascript, html, css',
	  content: tab + "Woah! He's back! All three of you reading this just said! Yes, I know it's been almost a week since I have uploaded a blog post. I have just been really busy with stuff, and also coding my first small project. I started off coding the drawing games, but then switched over to another idea. If anyone has played the game piccolo, I wanted to see if I could recreate that. Piccolo is a drinking game where all you do is listen to the prompts that the game tells you to do. It's relatively fun and seemed very simple to make. Low and behold I successfully made it within two days! You can go and look at it in my games section under Booze or Lose. And yes, I did switch over my projects tab to a games section. I moved my projects in my about me section because I feel like that's pretty much what that page is about. Anyway, back to Booze or Lose. I started off with making an object that included all of the prompts. Currently there are not many, so the games playability has limited fun and repetitiveness to it, but besides that it functions rather well. You can have up to 9 people in the game, that's just my choice because I am lazy, and choose from 1-40 rounds of prompts. That's just a random choice, that number can be as high as whatever i'd want it to be or to the max prompt limit. After that it was a lot of css messing around because I used 90 degree text and wow, I had a lot of trouble trying to get that to where I wanted it to. It's not perfect and that's probably the only thing that's bad about the game. I also added some other features like the background changes color for each prompt and the players names will appear in the prompts as well. That is why I chose to make it an object and not just an array. If you actually enjoy playing, then send me a message of prompt ideas to add! <br> <br>" + tab +
			         "Back to what I originally wanted to do, the Jackbox drawing game. The reason I want to make this oen so badly is that the Jackbox series is such a fun game, however it requires you to buy it off of steam, or another related website. This means that you are going to need a computer to play it. There are times where I don't have my computer or am at a friends house and we want to play but can't. So I want to make a mobile version so that we can play anywhere, and hopefully they come out with just a mobile version too. So the work I did for this so far is first of all, we are live  with Node.JS! It took me a little bit but we are now running the app with Node.JS and Socket.Io, through the hosting service of Heroku. The only downside of this is if I am not around my computer or with internet I can not update the blog, unlike what I did before through my phone. This is because I can only access it with git and a command prompt, so everything must be done on my computer. Heroku is really neat though and I definetly recommend using it if you want to make a Node.JS project. It's free and very customizable, even allowing a database for backend work, which I will be doing soon. Other than that I learned how the drawing app I got worked and customized it for my needs since that was only a static drawing app. It took a really long time trying to figure out how to copy the canvas from your client over to the server and send to everyone. Normally you can just send anything, like an object, variabl, or array, but canvases aapparently work differently. When you send a canvas over it apparently loses a lot of it's properties so once it gets back to the client, it's like a  car frame. All you see is the outside and nothing inside works. So to coutner this, I figured out a way to copy each individual stroke into an array and send that. Then when it passes to the client, the client redraws the strokes as if it was someone inputing them. Very confusing at first, but now the code seems very easy to read and I can now actually make the game. For that, like I said before, I made a game tab that has two options: Join Game or Make Game. Even for single player games you would go into make game. So let's make a game, we click that and then all of the available games that I made will appear here. Clicking one of those will bring up the settings for the game and you can launch it from there. I already explained Booze or Lose, so once you click Drawing Games, you should see that it wants you to add your name and a room name; This is where Node.JS comes in. By creating a room, you are setting up a 'server' that people can join. What you're reaslly doing is just saving a room object in an array that allows other people to join that room object. Each player is an object as well that will have their own properties, depending on what the game is. This is set so you can not have the same name in a room, and you can not have the same room name as someone else. All I have set up for this at the moment is you can make a room, join a room, and once you're in the room you can see who is in it. It is live so you see the name as soon as someone joins. There is also just a canvas at the bottom to fool around with and youc an share what you're drawing with others. That is basically all I have done within the past week. It may not ahve seemed like a lot, but there were so many concepts I just did not know."
	},
	{
	  date:'10/14/2018',
	  title:'Week 4 - Update On The Challenge and Drinking Game App Complete',
	  writer:'Robert Calamari',
	  pinned: '',
	  summary:"So it's been quite a while since I last posted, and that is because I was pretty sick for two weeks. Within those two weeks though, I just kept coding a little bit of booze or lose since I didn't really have the brain capacity to do anything else. However, the game works really well and I feel all I need to do now for it is just add some extra game types and 500 more question/prompts so it is not so repetitive. I also did some thinking and I am going to limit this blog to weekly posts...",
	  images:'',
	  tags:'coding100, javascript, html, css',
	  content: tab + "So it's been quite a while since I last posted, and that is because I was pretty sick for two weeks. Within those two weeks though, I just kept coding a little bit of booze or lose since I didn't really have the brain capacity to do anything else. However, the game works really well and I feel all I need to do now for it is just add some extra game types and 500 more question/prompts so it is not so repetitive. I also did some thinking and I am going to limit this blog to weekly posts because I believe I can do that. With my new job started, the daily posts were a bit strenuous and I have not been coding each day (besides the code that I do for my job). The whole point of this blog was to get good enough to get a job that involved coding, and while I did not get the job because of this, I do believe that it did help me significantly. I will still be coding on my own time but not as much, as I just don't know what I want to do right now. There are a few things I still need to fix for my website so I think those will be my main focus, and then I want to still try to finish that drawing app. Since I won't be coding as much, I am not sure if I will be keeping this purely as a coding blog or what, but I will try to figure that out by this weekend."
	}
];
